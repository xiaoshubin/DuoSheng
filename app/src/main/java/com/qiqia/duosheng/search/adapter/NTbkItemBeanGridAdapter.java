...
public class NTbkItemBeanGridAdapter extends BaseQuickAdapter<GoodsInfo, BaseViewHolder> {
    public NTbkItemBeanGridAdapter() {
        super(R.layout.item_ntbk_item_bean_grid);
    }
