...
public class ShareBottomPopup extends BottomPopupView {
    GoodsInfo item;
    Activity activity;
    public ShareBottomPopup(@NonNull Activity context, GoodsInfo info) {
        super(context);
    ...
    protected void onCreate() {
        ...
        findViewById(R.id.btn_share).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ShareUtils.shareImg(activity,null,activity.getString(R.string.app_name),"多省,用的多,省的多",bitmap);
            }
        });
